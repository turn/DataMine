...
public enum ProviderUserIdMetadata implements RecordMetadataInterface {
	...
	PROVIDER_TYPE((short)1, "provider_type", FieldTypeFactory.getPrimitiveType(PrimitiveType.BYTE), true, null, false, false, false, false),
	PROVIDER_ID((short)2, "provider_id", FieldTypeFactory.getPrimitiveType(PrimitiveType.INT32), true, null, false, false, false, false),
;
	...
	private ProviderUserIdMetadata(short id, String name, FieldType type, 
