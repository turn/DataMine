...
public class RecordMetaWrapperGenerator implements ElementVisitor, 
	...
	public void visit(Table table) {
		final String[] classCode = {
				...
				"    }",
				"",
				"    public {wrapperName}(RecordBuffer buffer) {",
				"        this.value = new Record<{baseClassName}>({baseClassName}.class, buffer);",
				"    }",
				"",
				"    @Override",
				...
				"		this.value = new Record<{baseClassName}>({baseClassName}.class, ",
